$(function () {
    ...
    $.ajax({
        type: "get",
        url: "http://localhost/bluesever/index_yuezhang.php",
        success: function (data) {
            data = JSON.parse(data)
            for (let i = 0; i < data.yuezhang.length; i++) {
                $(".d-list").append("\
                    <li class='d-item'>\
                        <div class='item-img'>\
                            <a href='#'>\
    ...
    $.ajax({
        type: "get",
        url: "http://localhost/bluesever/index_youji.php",
        success: function (data) {
            data = JSON.parse(data)
